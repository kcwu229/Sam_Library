        ...
        <div class="col-md-10">
          ...
          <div class="row align-items-center">
            <div class="col-lg-7 mb-5 mb-lg-0">
              ...
              <form:form class="border-right pr-5 mb-5" method="post" id="contactForm" name="contactForm" action="search_book">
                <div class="row">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <input type="submit" value="Search" class="btn btn-primary rounded-0 py-2 px-4">
