...
public class BookService {  
	...
	///////////////////////////////////////////   5. UPDATE  BOOK    //////////////////////////////////////////
	public void updateBook(String title, String author, String date, String publisher, String summary, boolean soldOut, Long id) {
		repo.updateBook(title, author, date, publisher, summary, soldOut, id);
	}
}